        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="inline-block mb-6">
              <span className="text-2xl font-bold text-white">Bright Edge <span className="text-amber-500">Interiors</span></span>
            </Link>
            <p className="text-gray-400 mb-6 leading-relaxed">
              Creating beautiful, functional spaces that reflect your style and enhance your lifestyle.
            </p>
            <div className="space-y-3">
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm">+91 8431866567/8317307240</span>
              </div>
              <div className="flex items-center">
                <svg className="w-5 h-5 text-amber-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-sm"> brightedgeinteriors@gmail.com </span>
              </div>
            </div>
          </div>
